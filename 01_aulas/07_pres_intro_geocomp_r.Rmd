...
# 7.8 Operação espaciais

## Operações locais - álgebra de raster
```{r}
# upper 600
...
```{r}
# prod
ra_rc_up_600_val <- ra_rc * ra_rc_up_600
ra_rc_up_600_val
```
...
```{r}
# replace
ra_rc_up_600_val_999 <- ra_rc_up_600_val
```
--
```{r}
ra_rc_up_600_val_999[ra_rc_up_600_val_999 > 800] <- 999
ra_rc_up_600_val_999
```
...
```{r}
# map
raster::plot(ra_rc_up_600_val_999)
plot(rc_2019$geom, add = TRUE)
```
