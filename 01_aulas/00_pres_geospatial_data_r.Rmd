...
Desenvolvimento de um projeto: 26/10 – 30/10 (30 horas)
...
1. Colunas como eixos do gráficos (*variáveis = colunas*)
1. Principais tipos de gráficos
1. Histograma (*histogram*)
1. Gráfico de setores (*pie chart* e *donut plot*)
1. Gráfico de barras (*bar plot*)
1. Gráfico de caixa (*box plot* e *violin plot*)
1. Gráfico de dispersão (*scatter plot*)
1. Gráfico pareado (*pairs plot*)
1. Gráficos animados (*gganimate*)
1. Combinando gráficos (*patchwork*)
...
background-image: url(img/package_ggplot2.png), url(img/package_tmap.png), url(img/package_leaflet.jpeg)
background-size: 200px, 200px, 200px
background-position: 55% 70%, 90% 90%, 90% 20%
...
background-position: 95% 35%,50% 95%
...
- realizar análises de dados geoespaciais e estatísticos
