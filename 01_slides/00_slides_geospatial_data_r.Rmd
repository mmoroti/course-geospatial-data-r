...
### Ministrada em 2019, a pedido do **Prof. Thiago Gonçalves Souza (Toyoyo)** na UFRPE

--

### Ministrada em 2020, a pedido do **Prof. Miltinho** na UNESP

--

### Ministrada agora em 2021, a pedido do **Prof. Miltinho** na UNESP
...
5 GitHub: Fork  
6 Configuração: RStudio, git, GituHub
...
20 Principal material de estudo
]
...
<br><br>
[ggplot2](https://ggplot2.tidyverse.org/), [tmap](https://r-tmap.github.io/tmap/), [mapsf](https://riatelab.github.io/mapsf/), [leaflet](https://rstudio.github.io/leaflet/)
...
background-position: 8% 40%, 51% 90%, 10% 80%, 90% 90%
...
- Participação, repositório e apresentação
