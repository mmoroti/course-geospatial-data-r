...
### **3. Indexação $ e mudanças de colunas**
...
### **4. Indexação $ e mudanças de colunas**
...
```{r include=FALSE}
# ler e atribuir uma planilha eletronica (.csv) a um objeto
da <- read.csv("/home/mude/data/github/course-geospatial-data-r/03_dados/tabelas/ATLANTIC_AMPHIBIANS_sites.csv", encoding = "latin1")
```
