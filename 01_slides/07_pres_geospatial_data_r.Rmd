...
kable(tibble(Classes = c("`sfg`", "`sfc`", "`sf`"), 
             ...
             Informação = c("Tipo de geometria e coordenadas", "Conjunto de `sfg` + CRS", "`sfc` + atributos")))
```
...
-   Classe sf - uma camada, que é uma coluna de geometria *sfc* dentro de um dataframe com atributos não espaciais (tabela de atributos)
