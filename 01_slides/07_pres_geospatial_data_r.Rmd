...
subtitle: "7 Estrutura e manipulação de dados vetoriais <br><br><br>"
...
# Um agradecimento ao Rafael (Urucum), que gentilmente cedeu os dados `r icon::fontawesome(name = "grin-beam-sweat", style = "solid")`
