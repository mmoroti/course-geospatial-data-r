...
subtitle: "9 Visualização de dados geoespaciais <br><br><br>"
...
class: inverse, center, middle
# Gostaria de agradecer a paciência e confiânça `r icon::fontawesome(name = "grin-beam-sweat", style = "solid")`
