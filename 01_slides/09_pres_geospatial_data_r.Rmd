...
knitr::opts_chunk$set(fig.retina = 3, fig.align = "center", warning = FALSE, message = FALSE, eval = FALSE)
...
class: inverse, center, middle
# Gostaria de agradecer a paciência e confiânça `r icons::icon_style(icons::fontawesome(name = "grin-beam-sweat", style = "solid"), fill = "#23373b")`
